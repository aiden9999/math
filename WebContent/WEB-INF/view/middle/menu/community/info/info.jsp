...
//     	});
    	...
    	function save(){
    		...
    		$.ajax({
    			type : "post",
    			url : "/middle/community/info/modify/${view.auto}/"+title+"/"+content,
    			async : false,
    			success : function(txt){
    				if(txt){
    					alert("수정되었습니다.");
    					location.href="/middle/community/info";
    				} else {
    					alert("수정에 실패하였습니다.\n잠시후 다시 시도해주세요.");
    				}
    			}
    	...
    	function removeYes(num){
    		$.ajax({
    			type : "post",
    			url : "/middle/community/info/remove/"+num,
    			async : false,
    			success : function(txt){
    				if(txt){
    					alert("삭제되었습니다.");
    	...
    	// 파일다운
    	function down(num){
    		location.href="/middle/community/info/down/"+num;
    	}
    </script>

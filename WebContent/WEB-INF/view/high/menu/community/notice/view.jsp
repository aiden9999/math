...
<html>
                    ...
                    <div class="contents">
                        ...
                        <section class="section01">
                            ...
                            <div class="board_modify_wrap">
	                            ...
	                            <div class="modify_txt" onclick="location.href='/high/community/notice'">
	                                <span>목록으로</span>
	                            </div>
                            </div>
                        </section>
    ...
    <script>
    	...
    	function save(){
    		...
    		$.ajax({
    			type : "post",
    			url : "/high/community/notice/modify/${view.auto}/"+title+"/"+content,
    			async : false,
    			success : function(txt){
    				if(txt){
    					alert("수정되었습니다.");
    					location.href="/high/community/notice";
    				} else {
    					alert("수정에 실패하였습니다.\n잠시후 다시 시도해주세요.");
    				}
    			}
    	...
    	function removeYes(num){
    		$.ajax({
    			type : "post",
    			url : "/high/community/notice/remove/"+num,
    			async : false,
    			success : function(txt){
    				if(txt){
    					alert("삭제되었습니다.");
    	...
    	// 파일다운
    	function down(num){
    		location.href="/high/community/notice/down/"+num;
    	}
    </script>

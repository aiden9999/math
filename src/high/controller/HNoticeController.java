...
@Controller
@RequestMapping("/high/community/notice")
public class HNoticeController {
	...
	public ModelAndView notice(){
		ModelAndView mav = new ModelAndView("/high/community/notice/notice.jsp");
	...
	public ModelAndView view(@PathVariable(name="num")int num, HttpServletRequest req, HttpServletResponse resp){
		ModelAndView mav = new ModelAndView("/high/community/notice/view.jsp");
		mav.addObject("menu", "notice");
		mav.addObject("hMenu", "hCommunity");
	...
	public ModelAndView write(){
		ModelAndView mav = new ModelAndView("/high/menu/community/notice/write.jsp");
		mav.addObject("menu", "notice");
		mav.addObject("hMenu", "hCommunity");
		return mav;
	}
